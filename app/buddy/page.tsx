              ...
              {[
                {
                  ...
                  body: "Anchor every spoken idea with a visual so the whole room reacts to the same thing. Verbal-only recall drops to 10% after three days. (Picture Superiority Effect, Medina)",
                  stat: "65%",
                ...
                },
                {
                  ...
                  body: "Timestamped decisions and action items prevent alignment drift. The #1 reason meetings fail is missing follow-up notes. (Drexel University)",
                  stat: "47%",
                ...
                },
                {
                  ...
                  body: "Draw, annotate, and vote together in real time — eliminating the brainstorm vacuum where ideas go unbuilt. (APA)",
                  stat: "3×",
