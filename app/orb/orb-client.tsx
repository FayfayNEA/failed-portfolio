...
// TODO: replace every value below with the real Orb details.
const META = [
...
export function OrbClient() {
  ...
  return (
    <div className="relative min-h-[100dvh] bg-[#f1f1ee]">
      <iframe
        src="https://floral-orb.vercel.app/"
          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-black/[0.06] px-6 py-4">
                <p className="font-mono text-[9px] uppercase tracking-[0.22em] text-zinc-400">Orb</p>
                <button
                  onClick={() => setOpen(false)}
                  aria-label="Close"
              ...
              <div className="px-6 py-5">
                {/* TODO: replace with the real Orb description */}
                <p className="mb-6 text-[0.88rem] leading-[1.8] text-zinc-600">
                  Placeholder description for Orb. Update this copy once the project details are set.
                </p>
