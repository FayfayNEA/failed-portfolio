...
// Clean 2×4 grid in design space. Still drag + resize on desktop.
const GRID_W = 510;
const GRID_H = 490;
/** 16:9 media (1080×608) — shorter cards than Buddy/E*Trade, centered on their row. */
const GRID_IMG_16_9 = Math.round((GRID_W * 9) / 16); // 287
const GRID_H_16_9 = GRID_IMG_16_9 + 176; // 463
const ROW_CENTER = (leftY: number, leftH: number, rightH: number) =>
  Math.round(leftY + (leftH - rightH) / 2);
const PRODUCT_DESIGN_LAYOUT: GalleryInitialLayout = {
  refWidth: 1372,
  positions: [
    { x: 116, y: 36   },  // buddy
    { x: 716, y: ROW_CENTER(36, GRID_H, GRID_H_16_9) },  // tetonic — vertically centered on Buddy
    { x: 116, y: ROW_CENTER(620, GRID_H, GRID_H_16_9) },  // eidolon — vertically centered on E*Trade
    { x: 716, y: 620  },  // etrade
    { x: 116, y: 1215 },  // teatimer
    { x: 716, y: ROW_CENTER(1215, GRID_H, GRID_H_16_9) },  // orb — vertically centered on TeaTimer
  ...
  sizesBySlug: {
    ...
    eidolon:      { w: GRID_W, h: GRID_H_16_9 },
    ...
    orb:          { w: GRID_W, h: GRID_H_16_9 },
    tetonic:      { w: GRID_W, h: GRID_H_16_9 },
  },
};

const PROJECTS: GalleryProject[] = [
  { slug: "buddy",        title: "Buddy",        statusLabel: "Shipped",     pillTheme: "purple", cardVariant: "portrait",  typeTags: "AI Hardware · IoT · B2B",                   description: "Created an LLM that captures group conversations as real-time images and diagrams.",      year: "2026", coverColor: "#f0f0f0", coverImageFit: "cover", coverImage: "/buddybackground.jpg", canvasCardW: 540, canvasImageH: 314, coverVideo: "/buddy/buddy-ui-mockup.mp4", coverVideoFit: "cover", coverVideoStartTime: 0, coverVideoStatic: true, hoverVideo: "/buddy/buddy-ui-mockup.mp4", href: "/buddy",        tags: ["64% intuitive on first use", "40% stopped taking notes", "2026"], tagsInline: true },
  { slug: "tetonic",      title: "Tetonic",      statusLabel: "Case Study",  pillTheme: "parchment", cardVariant: "landscape", typeTags: "Insurance · Logistics · B2B", description: "Livestock transit software for underwriting compliance and hauler load economics.", year: "2026", coverColor: "#fffcf6", coverImage: "/tetonic/tetonic-card-still.jpg", coverImageFit: "cover", canvasImageH: GRID_IMG_16_9, coverVideo: "/tetonic/tetonic-card.mp4", coverVideoFit: "cover", coverVideoStatic: true, hoverVideo: "/tetonic/tetonic-card.mp4", href: "/tetonic", tags: ["75% want real margins", "HTML · CSS · JS", "2026"], tagsInline: true },
  { slug: "eidolon",      title: "Eidolon",      statusLabel: "Case Study",  pillTheme: "green",  cardVariant: "landscape", typeTags: "AI Tool · Mobile · B2B · B2B2C",            description: "Designed what the web would look like as 98% AI and 2% human.",                                 year: "2026", coverColor: "#ffffff", coverImage: "/eidolon/hero-poster.jpg", coverImageFit: "cover", canvasImageH: GRID_IMG_16_9, coverVideo: "/eidolon/hero-alpha.mp4", coverVideoFit: "cover", coverVideoStatic: true, hoverVideo: "/eidolon/hero-alpha.mp4", href: "/eidolon",      tags: ["80% clearer agent in motion", "58% more control with haptics", "2026"], tagsInline: true },
  ...
  { slug: "orb",          title: "Orb",          statusLabel: "Shipped",     pillTheme: "purple", cardVariant: "landscape", typeTags: "Creative Tool · Web App · Consumer",         description: "An animated translucent blob with swirling internal caustics. A small WebGL playground for organic plasma forms.", year: "2026", coverColor: "#ffffff", coverImage: "/orb/orb-poster.jpg", coverImageFit: "cover", canvasImageH: GRID_IMG_16_9, coverVideo: "/orb/orb-card.mp4", coverVideoFit: "cover", coverVideoStatic: true, hoverVideo: "/orb/orb-card.mp4", href: "/orb",           tags: ["Three.js", "WebGL", "2026"], tagsInline: true },
...
export default function Home() {
  return (
    <main className="w-full bg-[var(--canvas)] [background-image:radial-gradient(var(--canvas-dot)_1px,transparent_1px)] [background-size:20px_20px] [background-attachment:fixed]">
      ...
      >
        <ProductDesignGallery projects={PROJECTS} storageKey="gallery-product-design-v153" initialLayout={PRODUCT_DESIGN_LAYOUT} />
      </section>
